 ...
 * @author win
 */
@WebServlet(name = "CreateSize", urlPatterns = {"/createsize"})
public class CreateSize extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("SizeCreate.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String prdAmount = request.getParameter("prdamount");
        
        DAO dao = new DAO();
        dao.insertSize(prdId, Integer.parseInt(prdSize), Integer.parseInt(prdAmount));
